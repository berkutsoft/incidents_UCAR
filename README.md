...
Создание или проведение миграций на момент первого запуска приложения не требуется, тк бд будет создаваться пустая со всей необходимой структурой таблиц. Однако, миграции нужны будут, когда БД уже существует
